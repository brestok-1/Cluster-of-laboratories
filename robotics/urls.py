...
from robotics.views import RoboticsMainView, BIMMainView, TechnicalVisionView, AgricultureView, ListProjectsView, \
    ListTechnologiesView, ListCoursesView, ProjectDetailView, TechnologyDetailView, CourseDetailView, TestingCenterView
...
urlpatterns = [
    ...
    path('BIM/testing-center/', TestingCenterView.as_view(), name='testing_center'),
